...
def calcular_formulas():
    ...
    c2=3*n1+n3
    c3=n3**3
    print(f'O produto do dobro do primeiro com metade do segundo é {c1:.2f}')
    print(f'A soma do triplo do primeiro com o terceiro é {c2:.2f}')
    print(f'O terceiro elevado ao cubo é {c3:.2f}')
